...
def on_activate(app):
    ...
    video = NyxGtk.Video()
    controls = NyxGtk.SimpleControls()
    ...
    item = Nyx.MediaItem(uri='http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4')
...
app = Adw.Application(application_id='com.example.NyxSimple')
