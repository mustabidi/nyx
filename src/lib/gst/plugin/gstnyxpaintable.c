...
#define GST_CAT_DEFAULT gst_nyx_paintable_debug
GST_DEBUG_CATEGORY_STATIC (GST_CAT_DEFAULT);

static void gst_nyx_paintable_iface_init (GdkPaintableInterface *iface);
static void gst_nyx_paintable_dispose (GObject *object);
static void gst_nyx_paintable_finalize (GObject *object);

#define parent_class gst_nyx_paintable_parent_class
G_DEFINE_TYPE_WITH_CODE (GstNyxPaintable, gst_nyx_paintable, G_TYPE_OBJECT,
    G_IMPLEMENT_INTERFACE (GDK_TYPE_PAINTABLE,
        gst_nyx_paintable_iface_init));

static void
gst_nyx_paintable_class_init (GstNyxPaintableClass *klass)
{
  GObjectClass *gobject_class = (GObjectClass *) klass;

  GST_DEBUG_CATEGORY_INIT (GST_CAT_DEFAULT, "nyxpaintable", 0,
      "Nyx Paintable");

  gobject_class->dispose = gst_nyx_paintable_dispose;
  gobject_class->finalize = gst_nyx_paintable_finalize;
}

static void
gst_nyx_paintable_init (GstNyxPaintable *self)
{
...
static void
gst_nyx_paintable_dispose (GObject *object)
{
  GstNyxPaintable *self = GST_NYX_PAINTABLE (object);

  GST_NYX_PAINTABLE_LOCK (self);
  ...
  GST_NYX_PAINTABLE_UNLOCK (self);

  GST_NYX_PAINTABLE_IMPORTER_LOCK (self);
  gst_clear_object (&self->importer);
  GST_NYX_PAINTABLE_IMPORTER_UNLOCK (self);

  GST_CALL_PARENT (G_OBJECT_CLASS, dispose, (object));
}

static void
gst_nyx_paintable_finalize (GObject *object)
{
  GstNyxPaintable *self = GST_NYX_PAINTABLE (object);
...
static gboolean
calculate_display_par (GstNyxPaintable *self, const GstVideoInfo *info)
{
...
static void
invalidate_paintable_size_internal (GstNyxPaintable *self)
{
...
static gboolean
invalidate_paintable_size_on_main_cb (GstNyxPaintable *self)
{
  GST_NYX_PAINTABLE_LOCK (self);
  self->draw_id = 0;
  GST_NYX_PAINTABLE_UNLOCK (self);
...
static gboolean
update_paintable_on_main_cb (GstNyxPaintable *self)
{
...
GstNyxPaintable *
gst_nyx_paintable_new (void)
{
  return g_object_new (GST_TYPE_NYX_PAINTABLE, NULL);
}

void
gst_nyx_paintable_set_widget (GstNyxPaintable *self, GtkWidget *widget)
{
  g_weak_ref_set (&self->widget, widget);
}

void
gst_nyx_paintable_set_importer (GstNyxPaintable *self, GstNyxImporter *importer)
{
  GST_NYX_PAINTABLE_IMPORTER_LOCK (self);
...
void
gst_nyx_paintable_queue_draw (GstNyxPaintable *self)
{
  GST_NYX_PAINTABLE_LOCK (self);
...
gboolean
gst_nyx_paintable_set_video_info (GstNyxPaintable *self, const GstVideoInfo *v_info)
{
  GST_NYX_PAINTABLE_LOCK (self);
...
void
gst_nyx_paintable_set_pixel_aspect_ratio (GstNyxPaintable *self,
...
void
gst_nyx_paintable_set_rotation (GstNyxPaintable *self,
...
gst_nyx_paintable_get_rotation (GstNyxPaintable *self)
{
  GstVideoOrientationMethod rotation;
 ...
 */
static void
gst_nyx_paintable_snapshot_internal (GstNyxPaintable *self,
    ...
    gint widget_width, gint widget_height)
{
  ...
  if (self->importer) {
    ...
    gst_nyx_importer_snapshot (self->importer, snapshot, snapshot_width, snapshot_height);
  } else {
...
static void
gst_nyx_paintable_snapshot (GdkPaintable *paintable,
    GdkSnapshot *snapshot, gdouble width, gdouble height)
{
  GstNyxPaintable *self = GST_NYX_PAINTABLE_CAST (paintable);
  GtkWidget *widget;
  ...
  gst_nyx_paintable_snapshot_internal (self, snapshot,
      width, height, widget_width, widget_height);
}

static GdkPaintable *
gst_nyx_paintable_get_current_image (GdkPaintable *paintable)
{
  GstNyxPaintable *self = GST_NYX_PAINTABLE_CAST (paintable);
...
static gint
gst_nyx_paintable_get_intrinsic_width (GdkPaintable *paintable)
{
  GstNyxPaintable *self = GST_NYX_PAINTABLE_CAST (paintable);
...
static gint
gst_nyx_paintable_get_intrinsic_height (GdkPaintable *paintable)
{
  GstNyxPaintable *self = GST_NYX_PAINTABLE_CAST (paintable);
...
static gdouble
gst_nyx_paintable_get_intrinsic_aspect_ratio (GdkPaintable *paintable)
{
  GstNyxPaintable *self = GST_NYX_PAINTABLE_CAST (paintable);
...
static void
gst_nyx_paintable_iface_init (GdkPaintableInterface *iface)
{
  iface->snapshot = gst_nyx_paintable_snapshot;
  iface->get_current_image = gst_nyx_paintable_get_current_image;
  iface->get_intrinsic_width = gst_nyx_paintable_get_intrinsic_width;
  iface->get_intrinsic_height = gst_nyx_paintable_get_intrinsic_height;
  iface->get_intrinsic_aspect_ratio = gst_nyx_paintable_get_intrinsic_aspect_ratio;
}
