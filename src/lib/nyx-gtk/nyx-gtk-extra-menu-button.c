...
#include "nyx-gtk-extra-menu-button.h"
...
#define GST_CAT_DEFAULT nyx_gtk_extra_menu_button_debug
GST_DEBUG_CATEGORY_STATIC (GST_CAT_DEFAULT);

struct _NyxGtkExtraMenuButton
{
  GtkWidget parent;
...
#define parent_class nyx_gtk_extra_menu_button_parent_class
G_DEFINE_TYPE (NyxGtkExtraMenuButton, nyx_gtk_extra_menu_button, GTK_TYPE_WIDGET)
...
static void
_set_action_enabled (NyxGtkExtraMenuButton *self, const gchar *name, gboolean enabled)
{
...
static gint
volume_spin_input_cb (GtkSpinButton *spin_button, gdouble *value, NyxGtkExtraMenuButton *self)
{
...
static gboolean
volume_spin_output_cb (GtkSpinButton *spin_button, NyxGtkExtraMenuButton *self)
{
...
static void
volume_spin_changed_cb (GtkSpinButton *spin_button, NyxGtkExtraMenuButton *self)
{
  GtkAdjustment *adjustment = gtk_spin_button_get_adjustment (spin_button);
  gdouble volume = gtk_adjustment_get_value (adjustment);
...
static gint
speed_spin_input_cb (GtkSpinButton *spin_button, gdouble *value, NyxGtkExtraMenuButton *self)
{
  const gchar *text = gtk_editable_get_text (GTK_EDITABLE (spin_button));
...
static gboolean
speed_spin_output_cb (GtkSpinButton *spin_button, NyxGtkExtraMenuButton *self)
{
  GtkAdjustment *adjustment = gtk_spin_button_get_adjustment (spin_button);
...
static void
speed_spin_changed_cb (GtkSpinButton *spin_button, NyxGtkExtraMenuButton *self)
{
  GtkAdjustment *adjustment = gtk_spin_button_get_adjustment (spin_button);
  gdouble speed = gtk_adjustment_get_value (adjustment);
...
visible_submenu_changed_cb (GtkPopoverMenu *popover_menu,
    GParamSpec *pspec G_GNUC_UNUSED, NyxGtkExtraMenuButton *self)
{
  gchar *name = NULL;
...
static void
_subtitles_enabled_changed_cb (NyxPlayer *player,
    GParamSpec *pspec G_GNUC_UNUSED, NyxGtkExtraMenuButton *self)
{
  ...
  enabled = nyx_player_get_subtitles_enabled (player);
...
{
  NyxGtkExtraMenuButton *self = NYX_GTK_EXTRA_MENU_BUTTON_CAST (user_data);
  gboolean enable = g_variant_get_boolean (value);

  if (G_LIKELY (self->player != NULL))
    nyx_player_set_subtitles_enabled (self->player, enable);
...
static void
_determine_top_separator_visibility (NyxGtkExtraMenuButton *self)
{
...
/**
 * nyx_gtk_extra_menu_button_new:
 *
 * Creates a new #NyxGtkExtraMenuButton instance.
 *
 * Returns: a new extra menu button #GtkWidget.
 */
GtkWidget *
nyx_gtk_extra_menu_button_new (void)
{
  return g_object_new (NYX_GTK_TYPE_EXTRA_MENU_BUTTON, NULL);
}

/**
 * nyx_gtk_extra_menu_button_set_volume_visible:
 * @button: a #NyxGtkExtraMenuButton
 * @visible: whether visible
 *
 * Set whether volume control inside popover should be visible.
 */
void
nyx_gtk_extra_menu_button_set_volume_visible (NyxGtkExtraMenuButton *self, gboolean visible)
{
  g_return_if_fail (NYX_GTK_IS_EXTRA_MENU_BUTTON (self));
...
/**
 * nyx_gtk_extra_menu_button_get_volume_visible:
 * @button: a #NyxGtkExtraMenuButton
 *
 ...
 */
gboolean
nyx_gtk_extra_menu_button_get_volume_visible (NyxGtkExtraMenuButton *self)
{
  g_return_val_if_fail (NYX_GTK_IS_EXTRA_MENU_BUTTON (self), FALSE);

  return gtk_widget_get_visible (self->volume_box);
}

/**
 * nyx_gtk_extra_menu_button_set_speed_visible:
 * @button: a #NyxGtkExtraMenuButton
 * @visible: whether visible
 *
 ...
 */
void
nyx_gtk_extra_menu_button_set_speed_visible (NyxGtkExtraMenuButton *self, gboolean visible)
{
  g_return_if_fail (NYX_GTK_IS_EXTRA_MENU_BUTTON (self));
...
/**
 * nyx_gtk_extra_menu_button_get_speed_visible:
 * @button: a #NyxGtkExtraMenuButton
 *
 ...
 */
gboolean
nyx_gtk_extra_menu_button_get_speed_visible (NyxGtkExtraMenuButton *self)
{
  g_return_val_if_fail (NYX_GTK_IS_EXTRA_MENU_BUTTON (self), FALSE);
...
/**
 * nyx_gtk_extra_menu_button_set_can_open_subtitles:
 * @button: a #NyxGtkExtraMenuButton
 ...
 * [class@Nyx.MediaItem]. When no media is selected, option to open subtitles
 * will not be shown regardless how this option is set.
 */
void
nyx_gtk_extra_menu_button_set_can_open_subtitles (NyxGtkExtraMenuButton *self, gboolean allowed)
{
  gboolean changed;
...
/**
 * nyx_gtk_extra_menu_button_get_can_open_subtitles:
 * @button: a #NyxGtkExtraMenuButton
 *
 ...
 */
gboolean
nyx_gtk_extra_menu_button_get_can_open_subtitles (NyxGtkExtraMenuButton *self)
{
  g_return_val_if_fail (NYX_GTK_IS_EXTRA_MENU_BUTTON (self), FALSE);
...
static void
nyx_gtk_extra_menu_button_init (NyxGtkExtraMenuButton *self)
{
  ...
  g_type_ensure (NYX_GTK_TYPE_STREAM_CHECK_BUTTON);
  ...
  gtk_widget_insert_action_group (GTK_WIDGET (self),
      "nyxgtk", G_ACTION_GROUP (self->action_group));
...
static void
nyx_gtk_extra_menu_button_compute_expand (GtkWidget *widget,
...
static void
nyx_gtk_extra_menu_button_realize (GtkWidget *widget)
{
  NyxGtkExtraMenuButton *self = NYX_GTK_EXTRA_MENU_BUTTON_CAST (widget);

  GST_TRACE_OBJECT (self, "Realize");

  if ((self->player = nyx_gtk_get_player_from_ancestor (GTK_WIDGET (self)))) {
    ...
    stream_list = nyx_player_get_video_streams (self->player);
    ...
    stream_list = nyx_player_get_audio_streams (self->player);
    selection = gtk_single_selection_new (gst_object_ref (stream_list));
    gtk_single_selection_set_autoselect (selection, FALSE);
    ...
    stream_list = nyx_player_get_subtitle_streams (self->player);
    selection = gtk_single_selection_new (gst_object_ref (stream_list));
    gtk_single_selection_set_autoselect (selection, FALSE);
...
static void
nyx_gtk_extra_menu_button_unrealize (GtkWidget *widget)
{
  NyxGtkExtraMenuButton *self = NYX_GTK_EXTRA_MENU_BUTTON_CAST (widget);
...
static void
popover_map_cb (GtkWidget *widget, NyxGtkExtraMenuButton *self)
{
  NyxQueue *queue;
  ...
  queue = nyx_player_get_queue (self->player);
...
static void
popover_unmap_cb (GtkWidget *widget, NyxGtkExtraMenuButton *self)
{
  NyxQueue *queue;
...
static void
nyx_gtk_extra_menu_button_dispose (GObject *object)
{
  NyxGtkExtraMenuButton *self = NYX_GTK_EXTRA_MENU_BUTTON_CAST (object);

  gtk_widget_dispose_template (GTK_WIDGET (object), NYX_GTK_TYPE_EXTRA_MENU_BUTTON);
...
static void
nyx_gtk_extra_menu_button_finalize (GObject *object)
{
  NyxGtkExtraMenuButton *self = NYX_GTK_EXTRA_MENU_BUTTON_CAST (object);
...
static void
nyx_gtk_extra_menu_button_get_property (GObject *object, guint prop_id,
    GValue *value, GParamSpec *pspec)
{
  ...
  switch (prop_id) {
    case PROP_VOLUME_VISIBLE:
      g_value_set_boolean (value, nyx_gtk_extra_menu_button_get_volume_visible (self));
      break;
    case PROP_SPEED_VISIBLE:
      g_value_set_boolean (value, nyx_gtk_extra_menu_button_get_speed_visible (self));
      break;
    case PROP_CAN_OPEN_SUBTITLES:
      g_value_set_boolean (value, nyx_gtk_extra_menu_button_get_can_open_subtitles (self));
      break;
    default:
...
static void
nyx_gtk_extra_menu_button_set_property (GObject *object, guint prop_id,
    const GValue *value, GParamSpec *pspec)
{
  ...
  switch (prop_id) {
    case PROP_VOLUME_VISIBLE:
      nyx_gtk_extra_menu_button_set_volume_visible (self, g_value_get_boolean (value));
      break;
    case PROP_SPEED_VISIBLE:
      nyx_gtk_extra_menu_button_set_speed_visible (self, g_value_get_boolean (value));
      break;
    case PROP_CAN_OPEN_SUBTITLES:
      nyx_gtk_extra_menu_button_set_can_open_subtitles (self, g_value_get_boolean (value));
      break;
    default:
      G_OBJECT_WARN_INVALID_PROPERTY_ID (object, prop_id, pspec);
      break;
...
static void
nyx_gtk_extra_menu_button_class_init (NyxGtkExtraMenuButtonClass *klass)
{
  GObjectClass *gobject_class = (GObjectClass *) klass;
  GtkWidgetClass *widget_class = (GtkWidgetClass *) klass;

  GST_DEBUG_CATEGORY_INIT (GST_CAT_DEFAULT, "nyxgtkextramenubutton", 0,
      "Nyx GTK Extra Menu Button");
  nyx_gtk_init_translations ();

  gobject_class->get_property = nyx_gtk_extra_menu_button_get_property;
  gobject_class->set_property = nyx_gtk_extra_menu_button_set_property;
  gobject_class->dispose = nyx_gtk_extra_menu_button_dispose;
  gobject_class->finalize = nyx_gtk_extra_menu_button_finalize;

  widget_class->compute_expand = nyx_gtk_extra_menu_button_compute_expand;
  widget_class->realize = nyx_gtk_extra_menu_button_realize;
  widget_class->unrealize = nyx_gtk_extra_menu_button_unrealize;

  /**
   * NyxGtkExtraMenuButton:volume-visible:
   *
  ...
  /**
   * NyxGtkExtraMenuButton:speed-visible:
   *
  ...
  /**
   * NyxGtkExtraMenuButton:can-open-subtitles:
   *
  ...
  /**
   * NyxGtkExtraMenuButton::open-subtitles:
   * @button: a #NyxGtkExtraMenuButton
   * @item: a #NyxMediaItem
   *
   ...
   * @item using [method@Nyx.MediaItem.set_suburi] method.
   *
   * This signal will pass the [class@Nyx.MediaItem] that was current when
   ...
   * setting [method@NyxGtk.ExtraMenuButton.set_can_open_subtitles] to %TRUE,
  ...
  signals[SIGNAL_OPEN_SUBTITLES] = g_signal_new ("open-subtitles",
      ...
      0, NULL, NULL, NULL, G_TYPE_NONE, 1, NYX_TYPE_MEDIA_ITEM);

  g_object_class_install_properties (gobject_class, PROP_LAST, param_specs);

  gtk_widget_class_set_template_from_resource (widget_class,
      NYX_GTK_RESOURCE_PREFIX "/ui/nyx-gtk-extra-menu-button.ui");

  gtk_widget_class_bind_template_child (widget_class, NyxGtkExtraMenuButton, menu_button);

  gtk_widget_class_bind_template_child (widget_class, NyxGtkExtraMenuButton, volume_box);
  gtk_widget_class_bind_template_child (widget_class, NyxGtkExtraMenuButton, volume_button);
  gtk_widget_class_bind_template_child (widget_class, NyxGtkExtraMenuButton, volume_spin);

  gtk_widget_class_bind_template_child (widget_class, NyxGtkExtraMenuButton, speed_box);
  gtk_widget_class_bind_template_child (widget_class, NyxGtkExtraMenuButton, speed_button);
  gtk_widget_class_bind_template_child (widget_class, NyxGtkExtraMenuButton, speed_spin);

  gtk_widget_class_bind_template_child (widget_class, NyxGtkExtraMenuButton, top_separator);

  gtk_widget_class_bind_template_child (widget_class, NyxGtkExtraMenuButton, video_list_view);
  gtk_widget_class_bind_template_child (widget_class, NyxGtkExtraMenuButton, video_sw);

  gtk_widget_class_bind_template_child (widget_class, NyxGtkExtraMenuButton, audio_list_view);
  gtk_widget_class_bind_template_child (widget_class, NyxGtkExtraMenuButton, audio_sw);

  gtk_widget_class_bind_template_child (widget_class, NyxGtkExtraMenuButton, subtitle_list_view);
  gtk_widget_class_bind_template_child (widget_class, NyxGtkExtraMenuButton, subtitle_sw);
  ...
  gtk_widget_class_set_css_name (widget_class, "nyx-gtk-extra-menu-button");
}
