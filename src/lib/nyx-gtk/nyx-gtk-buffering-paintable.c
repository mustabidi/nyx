...
struct _NyxGtkBufferingPaintable
{
  GObject parent;
...
nyx_gtk_buffering_paintable_get_flags (GdkPaintable *paintable)
{
  return GDK_PAINTABLE_STATIC_SIZE;
}

static gint
nyx_gtk_buffering_paintable_get_intrinsic_size (GdkPaintable *paintable)
{
...
static void
nyx_gtk_buffering_paintable_snapshot (GdkPaintable *paintable,
    GdkSnapshot *snapshot, gdouble width, gdouble height)
{
  NyxGtkBufferingPaintable *self = NYX_GTK_BUFFERING_PAINTABLE_CAST (paintable);
  guint i;
...
static GdkPaintable *
nyx_gtk_buffering_paintable_get_current_image (GdkPaintable *paintable)
{
  NyxGtkBufferingPaintable *self = NYX_GTK_BUFFERING_PAINTABLE_CAST (paintable);
  NyxGtkBufferingPaintable *copy = nyx_gtk_buffering_paintable_new ();
  guint i;
...
{
  iface->get_flags = nyx_gtk_buffering_paintable_get_flags;
  iface->get_intrinsic_width = nyx_gtk_buffering_paintable_get_intrinsic_size;
  iface->get_intrinsic_height = nyx_gtk_buffering_paintable_get_intrinsic_size;
  iface->snapshot = nyx_gtk_buffering_paintable_snapshot;
  iface->get_current_image = nyx_gtk_buffering_paintable_get_current_image;
}

#define parent_class nyx_gtk_buffering_paintable_parent_class
G_DEFINE_TYPE_WITH_CODE (NyxGtkBufferingPaintable, nyx_gtk_buffering_paintable, G_TYPE_OBJECT,
    G_IMPLEMENT_INTERFACE (GDK_TYPE_PAINTABLE, _paintable_iface_init))

NyxGtkBufferingPaintable *
nyx_gtk_buffering_paintable_new (void)
{
  return g_object_new (NYX_GTK_TYPE_BUFFERING_PAINTABLE, NULL);
}

void
nyx_gtk_buffering_paintable_step (NyxGtkBufferingPaintable *self)
{
  guint i;
...
void
nyx_gtk_buffering_paintable_reset (NyxGtkBufferingPaintable *self)
{
  guint i;
...
static void
nyx_gtk_buffering_paintable_init (NyxGtkBufferingPaintable *self)
{
}

static void
nyx_gtk_buffering_paintable_class_init (NyxGtkBufferingPaintableClass *klass)
{
}
